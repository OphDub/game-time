...
describe('CentipedeSeg', function() {
  ...
  it('expects to have a radius', function() {
  ...
  it('expects to move down one grid block when segment hits the left canvas wall', function() {
    let centipedeSeg = new CentipedeSeg(12, 36, -6, 24, 12, 'blue');
  ...
  it('expects to move down one grid block when segment hits the right canvas wall', function() {
    let centipedeSeg = new CentipedeSeg(708, 36, 6, 24, 12, 'blue');
  ...
  it('expects to change y velocity and move up one grid when segment reaches the bottom canvas restraint', function() {
  ...
  it('expects to constrain segment movement to bottom of canvas when it reaches bottom canvas restraint', function() {
    let centipedeSeg = new CentipedeSeg(12, 730, -6, 24, 12, 'blue');
  ...
  it('expects to not go below 550 on the y axis if it has already reached lower half', function() {
  ...
  it('expects to collide with objects when they are in the same x and y plane', function() {
  ...
  it('expects to detect collision with mushrooms and change the x velocity', function() {
  ...
  it('expects to detect collision with mushrooms and move down one grid', function() {
    let shroom = new Mushroom(130, 118);
    let shroomArray = [shroom];
