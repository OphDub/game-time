// put GAME class into its own file
class Game {
  ...
  gameLoop() {
    ...
    this.centipede.centBulletCollision(this.player.gun.bulletArray, this.mushroomArray);
    this.centipede.update(this.context, this.mushroomArray, this.player);
