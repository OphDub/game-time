...
let image = new Image('../images/unicorn-sprite.png');
image.src = ('../images/unicorn-sprite.png');
...
class Player extends GamePiece {
  ...
  draw(context) {
    context.drawImage(image, 0, 0, 200, 190, this.x, this.y, this.width, this.height);
